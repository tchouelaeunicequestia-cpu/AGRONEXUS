...
class FarmerDashboard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Farmer Management Portal'),
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text(
              'Produce Batch Inventory',
              style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold),
            ),
            const SizedBox(height: 8),
            const Text('Manage spatial produce listings and post-harvest storage.'),
            ...
            ElevatedButton.icon(
              ...
              label: const Text('List New Produce Batch (FR2.1)', style: TextStyle(fontSize: 16)),
            ),
          ],
        ),
      ),
...
*(Imports `FarmerDashboard` and links it to `case 'FARMER':`)* [cite: 3]
